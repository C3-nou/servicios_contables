<?php
	...
	$pages = array(
		...
		'2'	=> array('id' => '5', 'alias' => 'Services', 'file' => '5.php','controllers' => array()),
		'3'	=> array('id' => '3', 'alias' => 'Contacts', 'file' => '3.php','controllers' => array())
	);
	$forms = array(
		'3'	=> array(
			'c7fabd2b' => Array( 'email' => '', 'emailFrom' => '', 'subject' => 'Enquire from the web page', 'sentMessage' => unserialize('s:14:"Form was sent.";'), 'object' => '', 'objectRenderer' => '', 'loggingHandler' => '', 'smtpEnable' => false, 'smtpHost' => null, 'smtpPort' => null, 'smtpEncryption' => null, 'smtpUsername' => null, 'smtpPassword' => null, 'recSiteKey' => null, 'recSecretKey' => null, 'maxFileSizeTotal' => null, 'fields' => array( array( 'fidx' => '0', 'name' => 'Name', 'type' => 'input', 'required' => 1, 'options' => '' ), array( 'fidx' => '1', 'name' => 'E-mail', 'type' => 'input', 'required' => 1, 'options' => '' ), array( 'fidx' => '2', 'name' => 'Message', 'type' => 'textarea', 'required' => 1, 'options' => '' ) ) )
		)
	);
	$langs = null;
	$def_lang = null;
	$base_lang = 'en';
	$site_id = "90fb0cba";
	$websiteUID = "b8874ca53de459c082d2c9644689d8bbae22f8cfe0656abf4e170bc81ce17db6ae0e311c48276ef3";
	$base_dir = dirname(__FILE__);
	$base_url = '/';
	$user_domain = 'nouliet.000webhostapp.com';
	$home_page = '1';
	$mod_rewrite = true;
	$show_comments = false;
	$comment_callback = "http://us.zyro.com/comment_callback/";
	$user_key = "szdzHA2eC70vdmRlYJuy3xcKXho1QeoRlw==";
	$user_hash = "301604ea99ad628e";
